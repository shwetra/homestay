...
const GuestsInput: FC<GuestsInputProps> = ({ className = 'flex-1', onTotalChange }) => {
  ...
  const updateTotal = (
    ...
    const total = guestsAdults + guestsChildren + guestsInfants;
    onTotalChange?.(total);
  };
  ...
  const handleChangeData = (value: number, type: string) => {
    ...
    updateTotal(newValue.guestAdults, newValue.guestChildren, newValue.guestInfants);
  };
